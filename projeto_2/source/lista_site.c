...
//                (atual != NULL && site_get_codigo(atual->site) <= codigo && ORDENADA)) {
//             // Compara o elemento
...
//                (ORDENADA && no_atual != NULL) && (site_get_codigo(no_atual->site) < codigo)) {
//             no_anterior = no_atual;
//             no_atual = no_atual->proximo;
//         }

//         if (no_atual != NULL && site_get_codigo(no_atual->site) == codigo) {
